...
public record FarmerInquiryRequest(
        ...
        @NotBlank @Size(max = 80) String farmingType,
        @NotBlank @Size(max = 80) String landArea,
        @NotBlank @Size(max = 255) String mainCrops,
        @NotBlank @Size(max = 80) String irrigationType,
